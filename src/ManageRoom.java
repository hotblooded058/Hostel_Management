...
public class ManageRoom extends javax.swing.JFrame {
    public void clear()           //clears all previous entered details on manage room page
    {
        jTextField1.setText("");
        jTextField2.setText("");
    ...
    {
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel(); //DefaultTableModel obj "dtm" is used to manipulate the table on manage room page
        dtm.setRowCount(0);
        try
        {
            Connection con = ConnectionProvider.getCon();  // for establishing connection with database
            Statement st = con.createStatement();  //Statement provides object for executing sql queries
            ResultSet rs = st.executeQuery("select *from room"); // ResultSet provides obj which stores result of sql query,the rs stores all the rows of table room
            while(rs.next()) //iterate over all the rows of table "room"
            {
                dtm.addRow(new Object[]{rs.getString(1),rs.getString(2),rs.getString(3)});  //for adding rows to jTable on manage room page
            }
        }
        catch(Exception e)
        {
